...
This is a prototype open source Unity game. You can find the latest build on [itch.io](https://wizardscode.itch.io/rogue-wave). 

Everything in this repo is MIT or CC0 licensed, however, in order to compile the game you will need a number of assets from the store, see the full list below.
...
* [ForceField Effects (v1.4)](https://assetstore.unity.com/packages/slug/123431?aid=1101l866w) - SineVFX
* [Mystic Arsenal (v1.0b)](https://assetstore.unity.com/packages/slug/100969?aid=1101l866w) - 
...
* [Power-up FX (v1.1)](https://assetstore.unity.com/packages/slug/152740?aid=1101l866w) - 
* [Project Asset Manager (v1.48.0001)](https://assetstore.unity.com/packages/slug/126313?aid=1101l866w) - Doubling Technologies
* [ProTips - Tooltip System (v1.7.6a)](https://assetstore.unity.com/packages/slug/44361?aid=1101l866w) - ModelShark Studio
* [Sprite Shaders Ultimate (v6.6)](https://assetstore.unity.com/packages/slug/158988?aid=1101l866w) - Ekincan Tas
* [Variety FX 2.0 (v1.0.1)](https://assetstore.unity.com/packages/slug/235241?aid=1101l866w) - 
...
There are a few things you need to do to make this compile as we use Assembly Definitions and not all assets provide them. So first thing you need to do is grow through all the above and if they do not provide an assembly definition you need to add one.

We've also needed to make some changes to code here and there. Below are some notes on how to automatically copy over some of these changes, but others cannot be packaged in this way for licensing reasons. You are on your own here. Most of the changes should be self explanatory (e.g. changing scope of methods). If you get stuck then reach out on Discord.

A small number of files from [NeoFPS](https://bit.ly/NeoFPS) are included in this repo. These files are auto generated by [NeoFPS](https://bit.ly/NeoFPS) or they contain no significant proprietary logic and are included with the kind permission of the author. However, there are a few small changes that need to be made to code that cannot be included for licensing reasons. These are documented below.

Add the following lines to `NeoSceneManager`:
...
In `BasicHealthManager` add a null check (`?`) to the following event invocation in `OnHealthCHanged`:
