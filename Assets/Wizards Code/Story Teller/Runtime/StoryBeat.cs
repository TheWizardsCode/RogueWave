...
namespace WizardsCode.StoryTeller
{
    ...
    public class StoryBeat : ScriptableObject, IStoryBeat
    {
        ...
        [Header("Audio")]
        [SerializeField, Tooltip("The preferred voice actor for this story beat step. This will be used to select the voice actor for the tutorial content."), BoxGroup("Audio")]
        public Constants.Actor actor;
        [SerializeField, Tooltip("An audio clip from this collection will be played at the start of this scene."), BoxGroup("Audio")]
...
#pragma warning restore CS0414
        ...
        void PlayClip()
        {
            ...
            if (duration == 0)
            {
                duration = clip.length + 1;
            }

            if (clip != null)
            {
                Debug.LogError("Requesting playback of a clip, but it's not implemented yet" + clip.name);
        ...
        public virtual IEnumerator Execute()
        {
            ...
            Debug.Log("Starting execution of " + displayName);
        ...
        void FinishExecution() {
            Debug.Log("Finishing execution of " + displayName);
