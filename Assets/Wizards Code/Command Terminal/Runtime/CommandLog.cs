...
namespace WizardsCode.CommandTerminal
{
    ...
    public class CommandLog
    {
        ...
        int max_items;
        private StringBuilder _lastCommandOutput = new StringBuilder();

        public string LastCommandOutput
        {
            get => _lastCommandOutput.ToString();
        }
        ...
        public void ClearLastCommandOutput()
        {
        ...
        public void HandleLog(string message, string stack_trace, TerminalLogType type) {
            ...
            logs.Add(log);
            _lastCommandOutput.Append(message);
